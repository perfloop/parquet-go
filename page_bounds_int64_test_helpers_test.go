...
const (
	...
	// This is the existing 1 MiB handoff from separate min and max scans to the
	// general combined kernel. Keep the test boundary independent from the amd64
	// implementation constant so purego test builds compile.
