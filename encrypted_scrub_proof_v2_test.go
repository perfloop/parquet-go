//go:build perfloop_scrub_proof_v2
...
// helpers. This tagged proof source is retained with the large compressed-dictionary guard and
...
func TestEncryptedPageReuseDoesNotExposePriorOffsets(t *testing.T) {
	...
	for range 512 {
		...
		attackerValues := attacker.Data()
		attackerPlaintext, attackerOffsets := attackerValues.Data()
